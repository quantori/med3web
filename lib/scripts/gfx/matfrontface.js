...
export default class MaterialFF {
  ...
  */
  create(scene) {
    ...
    shaderMaterial.setVector4('PlaneX', new BABYLON.Vector4(-1.0, 0.0, 0.0, 0.5));
    shaderMaterial.setVector4('PlaneY', new BABYLON.Vector4(0.0, -1.0, 0.0, 0.5));
    shaderMaterial.setVector4('PlaneZ', new BABYLON.Vector4(0.0, 0.0, -1.0, 0.5));
