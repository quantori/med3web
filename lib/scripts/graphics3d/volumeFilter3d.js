...
export default class VolumeFilter3d {
   ...
   */
  updateTextureBuffer() {
    console.log('Applying updateTextureBuffer ...');
    //this.material.uniforms.blurSigma.value = blurSigma;
    //this.material.uniforms.blurSigma.needsUpdate = true;
    ...
    // TODO: replace ALPHA to R
    // if (this.texFormat === BABYLON.Engine.TEXTUREFORMAT_ALPHA) {
    if (this.texFormat === BABYLON.Engine.TEXTUREFORMAT_R) {
  ...
  createUpdatableVolumeTex(engine2d, isRoiVolume, roiColors, bScene) {
    ...
    // TODO: TEXTUREFORMAT_ALPHA is bad format. Better to use BABYLON.Engine.TEXTUREFORMAT_R
    // it is more compatible with webgl for some
    // unknown babylon's/WebGL internal implementation reason
    //
    // let volume3dTexFormat = BABYLON.Engine.TEXTUREFORMAT_ALPHA;
    let volume3dTexFormat = BABYLON.Engine.TEXTUREFORMAT_R;
