...
export default class GlCheck {
  ...
  constructor() {
    ...
    try {
      ...
      this.m_staticCanvas = document.createElement('canvas');
      this.m_staticContext = this.m_staticCanvas.getContext('webgl') || canvas.getContext('experimental-webgl');

      const exts = this.m_staticContext.getSupportedExtensions();
      this.m_webglVersion = this.m_staticContext.getParameter(this.m_staticContext.VERSION);

      this.m_maxTextureSize = this.m_staticContext.getParameter(this.m_staticContext.MAX_TEXTURE_SIZE);
      ...
      const extInfo = this.m_staticContext.getExtension('WEBGL_debug_renderer_info');
      ...
      if (extInfo) {
        ...
        this.m_webglRenderer = this.m_staticContext.getParameter(extInfo.UNMASKED_RENDERER_WEBGL);
      }
...
GlCheck.m_staticCanvas = null;
GlCheck.m_staticContext = null;
