...
export default class Graphics3d {
  createBabylonScene() {
    ...
    const lowresRenderTexture = new BABYLON.RenderTargetTexture('lowres',
      { width: this.windowWidth / VAL_3, height: this.windowHeight / VAL_3 },
      scene);
  ...
  */
  ...
  switchToVolumeRender() {
    ...
    //  this.renderState = this.RENDER_STATE.ENABLED;
      //}
    if (this.isRoiVolume > 0) {
      this.bVolumeMaterialLoader.setIsosurfaceRenderMode(4);
      this.bLowResMaterialLoader.setIsosurfaceRenderMode(4);
    } else {
      this.bVolumeMaterialLoader.setIsosurfaceRenderMode(0);
      this.bLowResMaterialLoader.setIsosurfaceRenderMode(0);
    }
    // this.renderState = this.RENDER_STATE.ONCE;
  }
  /**
  ...
  switchToFullVolumeRender() {
    ...
    if (this.isRoiVolume > 0) {
      ...
      this.bVolumeMaterialLoader.setIsosurfaceRenderMode(3);
      this.bLowResMaterialLoader.setIsosurfaceRenderMode(3);
    }
    //  this.renderState = this.RENDER_STATE.ONCE;
  }
  /**
  ...
  switchToIsosurfRender() {
    ...
    //}
    if (this.isRoiVolume > 0) {
      this.bVolumeMaterialLoader.setIsosurfaceRenderMode(5);
      this.bLowResMaterialLoader.setIsosurfaceRenderMode(5);
    } else {
      this.bVolumeMaterialLoader.setIsosurfaceRenderMode(1);
      this.bLowResMaterialLoader.setIsosurfaceRenderMode(1);
    }
    // this.renderState = this.RENDER_STATE.ONCE;
  }
  /**
  ...
  switchToFLATRender() {
    ...
    //  // this.renderState = this.RENDER_STATE.ONCE;
    //this.renderState = this.RENDER_STATE.ENABLED;
    this.bVolumeMaterialLoader.setIsosurfaceRenderMode(2);
    this.bLowResMaterialLoader.setIsosurfaceRenderMode(2);
    // this.renderState = this.RENDER_STATE.ONCE;
  }
  ...
  callbackCreateCubeVolumeBF(window, box, nonEmptyBoxMin, nonEmptyBoxMax, isRoiVolume = false) {
    ...
    this.bVolumeMaterial.setFloat('texSize', this.engine2d.m_volumeHeader.m_pixelWidth);
    ...
    this.bLowResMaterial.setVector3('lightDir', new BABYLON.Vector3(this.curFileDataType.lightDirComp,
      this.curFileDataType.lightDirComp, this.curFileDataType.lightDirComp));
    this.bLowResMaterial.setFloat('texSize', this.engine2d.m_volumeHeader.m_pixelWidth);
